...
/*   Updated: 2023/12/06 13:44:24 by bohlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(void)
{
	...
	this->name = "Keeper";
	this->hit_point = this->hit_point_max = this->scav_health_max;
	this->energy_point = this->energy_point_max = this->scav_energy_max;
	this->attack_damage = this->scav_default_damage;
	this->gateStatus = 0;
}
...
ScavTrap &ScavTrap::operator= (const ScavTrap &target)
{
	...
	if (this != &target)
	{
		...
		this->hit_point_max = scav_health_max;
		this->energy_point_max = scav_energy_max;
	}
	return *this;
}
