...
/*   Updated: 2023/12/06 13:48:45 by bohlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(void)
{
	...
	this->name = "Somebody";
	this->hit_point = this->hit_point_max = this->frag_health_max;
	this->energy_point = this->energy_point_max = this->frag_energy_max;
	this->attack_damage = this->frag_default_damage;
}
...
FragTrap &FragTrap::operator= (const FragTrap &target)
{
	...
	if (this != &target)
	{
		...
		this->hit_point_max = this->frag_health_max;
		this->energy_point_max = this->frag_energy_max;
